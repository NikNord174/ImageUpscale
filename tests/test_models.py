...
from src.models.unet_skip_v2 import UNet as UNetV2
...
if __name__ == "__main__":
    ...
    modelV2 = UNetV2(n_channels=[1], o_channels=[1]).to(device)
    # print('Model: ', modelV1)
    ...
    total_params = sum(p.numel() for p in modelV2.parameters())
